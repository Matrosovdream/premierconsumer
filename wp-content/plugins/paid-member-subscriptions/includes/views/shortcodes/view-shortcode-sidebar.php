...
/*
  ...
  if(isset($member->subscriptions) && !empty($member->subscriptions)){
        ...
        //if($member->subscriptions[0]["status"]  == "active"){
          ...
          if($subscription_plan_id == "7231" || $same_plan == "7231"){ ?>
          ...
          <?php }elseif($subscription_plan_id == "7769" || $subscription_plan_id == "11984" || $subscription_plan_id == "22874" || $same_plan == "11984"){ ?>
            <div class="side-cols side-col1">
                <?php if ( is_active_sidebar( 'max-pro' ) ) : ?>
                    <?php dynamic_sidebar( 'max-pro' ); ?>
                <?php endif; ?>
            </div>
          <?php }elseif($subscription_plan_id == "7770" || $subscription_plan_id == "12039" || $subscription_plan_id == "22873" || $same_plan == "12039"){ ?>
            <div class="side-cols side-col1">
