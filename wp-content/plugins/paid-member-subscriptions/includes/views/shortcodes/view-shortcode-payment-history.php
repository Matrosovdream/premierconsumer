    ...
    <thead>
        ...
        ?>
            <tr>
                ...
                <th class="pms-payment-amount"><?php esc_html_e( 'Monto', 'paid-member-subscriptions' ); ?></th>
                <th class="pms-payment-date"><?php esc_html_e( 'Fecha / El tiempo', 'paid-member-subscriptions' ); ?></th>
...
<?php }else{ // Add payments 
    if($site_lang == "es"){
    ?>
        <p class="pms-no-payments"><?php esc_html_e( 'No se encontraron pagos', 'paid-member-subscriptions' ); ?></p>
    <?php
    }else{?>
