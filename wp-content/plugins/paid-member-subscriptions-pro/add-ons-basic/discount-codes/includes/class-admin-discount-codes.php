        ...
        public static function manage_posts_custom_column( $column, $post_id ) {
            ...
            if ($column == 'start-date') {
                if ( !empty( $discount_code->start_date ) )
                    echo esc_html( apply_filters( 'pms_match_date_format_to_wp_settings', $discount_code->start_date , false ));
                else
            ...
            if ($column == 'expiration-date') {
                if ( !empty($discount_code->expiration_date) )
                    echo esc_html( apply_filters('pms_match_date_format_to_wp_settings', $discount_code->expiration_date , false ));
                else
