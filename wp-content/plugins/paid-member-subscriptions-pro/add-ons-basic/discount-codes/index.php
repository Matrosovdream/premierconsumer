...
function pms_in_dc_output_discount_box( $output, $include, $exclude_id_group, $member, $pms_settings, $subscription_plans ){
    ...
    if( $total_price !== 0 ) {
        ...
        $discount_output .= '<input id="pms_subscription_plans_discount_code" name="discount_code" placeholder="' . apply_filters( 'pms_form_input_placeholder_discount_code', __( 'Enter discount', 'paid-member-subscriptions' ) ) . '" type="text" value="' . $discount_code_value . '" />';
...
function pms_in_dc_output_apply_discount_message() {
    ...
    if( empty( $_POST['pmstkn_original'] ) )
        die();
