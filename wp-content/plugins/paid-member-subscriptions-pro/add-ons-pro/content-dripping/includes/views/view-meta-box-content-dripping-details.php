...
<div class="pms-meta-box-field-wrapper">
    ...
    <label for="pms-content-dripping-set-subscription-plan" class="pms-meta-box-field-label"><?php esc_html_e( 'Subscription Plan', 'paid-member-subscriptions' ); ?></label>
    ...
    <p class="description"><?php esc_html_e( 'Select the subscription plan for which this content dripping set should apply.', 'paid-member-subscriptions' ); ?></p>

</div>

<div class="pms-meta-box-field-wrapper">

    <label for="pms-content-dripping-set-status" class="pms-meta-box-field-label"><?php esc_html_e( 'Status', 'paid-member-subscriptions' ); ?></label>
    ...
    <p class="description"><?php esc_html_e( 'Select content dripping set status.', 'paid-member-subscriptions' ); ?></p>
