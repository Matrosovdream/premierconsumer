jQuery( function( $ ) {
    ...
    $(document).on('submit', '.pms-form', function (e) {     
        ...
        // Skip if the Go Back button was pressed - custom code teqtop
        if ( (!e.originalEvent || !e.originalEvent.submitter || $(e.originalEvent.submitter).attr('name') != 'pms_redirect_back') && e.originalEvent !== undefined) {
    ...
    $(document).on( 'click', payment_buttons, stripeIntentsPaymentGatewayHandler ) // TEQTOP custom code
