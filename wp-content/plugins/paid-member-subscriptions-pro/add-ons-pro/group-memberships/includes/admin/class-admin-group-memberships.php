...
Class PMS_IN_Admin_Group_Memberships {
    ...
    public function add_group_fields() {
        ...
        <div class="pms-meta-box-field-wrapper pms-group-memberships-field">
            <label class="pms-meta-box-field-label" for="pms_group_name"><?php echo esc_html__( 'Group Name *', 'paid-member-subscriptions' ); ?></label>
        ...
        <div class="pms-meta-box-field-wrapper pms-group-memberships-field">
            <label class="pms-meta-box-field-label" for="pms_group_description"><?php echo esc_html__( 'Group Description', 'paid-member-subscriptions' ); ?></label>
