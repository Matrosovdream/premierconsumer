    ...
    ?>
        ...
        <form id="pms-admin-add_users" class="pms-form" method="POST">
            ...
            <div class="add-users-box">
                <label for="pms_emails_to_invite"><?php esc_html_e( 'User(s) to add as members of your Group Subscription:', 'paid-member-subscriptions' ); ?></label>
