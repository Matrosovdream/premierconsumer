...
Class PMS_IN_Group_Memberships {
    ...
    public function __construct(){
         ...
         */
         ...
         // Group Custom Fields
         add_filter( 'wppb_check_form_field_subscription-plans', array( $this, 'pb_validate_group_fields' ), 30 );
    ...
    public function invite_members(){
        ...
        else $emails = $_POST['pms_emails_to_invite']; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
    ...
    public function pb_validate_group_fields( $message ){
    ...
    private function get_members_row_actions( $reference, $subscription_id ){
        ...
        if( !is_numeric( $reference) || !pms_in_gm_is_group_owner( $reference ) )
