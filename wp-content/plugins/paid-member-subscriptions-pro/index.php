...
function pms_pro_activate( $network_wide ) {
    ...
    if( is_plugin_active('paid-member-subscriptions-basic/index.php') || is_plugin_active('paid-member-subscriptions-elite/index.php') || is_plugin_active('paid-member-subscriptions-unlimited/index.php') ){
...
function pms_pro_admin_notice(){
    ...
    if( $pms_deactivate_pro ){
        ...
        else if( is_plugin_active('paid-member-subscriptions-elite/index.php') )
            $other_plugin_name = 'Paid Member Subscriptions - Elite';
