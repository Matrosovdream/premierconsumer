				...
				<table border="0" cellpadding="0" cellspacing="0" width="480" >
					<tr>
						<td bgcolor="#ffffff" align="left" valign="top" style="padding: 30px 30px 20px 30px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; line-height: 48px;">
							<h1 style="font-size: 28px; font-weight: 400; margin: 0;text-align: center;">Datos de acceso para %tmp_title% Education</h1>
						</td>
					</tr>
				</table>
			</td>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td colspan="2" style="padding-left:30px;padding-right:15px;padding-bottom:10px; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
										<h4>Hola %name%,</h4>
										<p>Se ha registrado con éxito en nuestra clase de educación %tmp_t_content%. <a href="%login_link%" target="_blank" style="color:#3441a4;">Haga clic aquí para iniciar sesión</a> con el siguiente ID de usuario y contraseña.</p>
										<p><strong>UserId:</strong> %mim_user%
										<br><strong>Contraseña:</strong> %mim_pass%</p>
										<br>
										<p>Aquí está el ID de inicio de sesión del cónyuge y la contraseña.</p>
										<p><strong>Cónyuge UserId:</strong> %mim_suser%
										<br><strong>Contraseña del cónyuge:</strong> %mim_spass%</p>
										<br>
										<p>Gracias y saludos<br/>Premier Consumer Team</p>
										<br>
									</td>
								</tr>
							</table>
