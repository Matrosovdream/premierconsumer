					...
					<table border="0" cellpadding="0" cellspacing="0" width="480" >
						<tr>
							<td align="center" valign="top" style="padding: 40px 10px 40px 10px;">
								<div style="display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 18px;" border="0"><img src="https://premierconsumer.org/wp-content/uploads/2021/09/logo.jpg" style="width: 55%;"></div>
							</td>
						</tr>
					</table>
				</td>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="480" >
						<tr>
							<td bgcolor="#ffffff" align="left" valign="top" style="padding: 30px 30px 20px 30px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; line-height: 48px;">
								<h1 style="font-size: 28px; font-weight: 400; margin: 0;text-align: center;">Documents Uploded on shareFile</h1>
							</td>
						</tr>
					</table>
				</td>
				...
				<td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
                  ...
                  <tr>
                    <td colspan="2" style="padding-left:30px;padding-right:15px;padding-bottom:10px; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                      <p>Please check shareFile account. Verify new documents uploaded by <strong>%user_name%</strong> and update "Poverty Line Verification Status" in user profile by visting below link.</p>
                    </td>
                  </tr>
        </table>
							</td>
									...
									<tr>
										<td bgcolor="#ffffff" align="center" style="padding: 30px 30px 30px 30px; border-top:1px solid #dddddd;">
											<table border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td align="left" style="border-radius: 3px;" bgcolor="#3441a4">
														<a href="https://premierconsumer.org/wp-admin/user-edit.php?user_id=%edit_profile_link%" target="_blank" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 11px 22px; border-radius: 2px; border: 1px solid #3441a4; display: inline-block;">User Profile</a>
													</td>
												</tr>
											</table>
										</td>
