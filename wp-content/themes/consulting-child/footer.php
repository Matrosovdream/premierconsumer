...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-body">
      <button type="button" class="close" data-dismiss="modal">&times;</button>     
      <img src="https://premierconsumer.org/wp-content/uploads/2021/10/Sara-Registar-1634528023834-1.png"> 
...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-body">
      <button type="button" class="close" data-dismiss="modal">&times;</button>     
      <img src="https://premierconsumer.org/wp-content/uploads/2021/10/sectigo_logo_black.svg"> 
...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-body">
      <button type="button" class="close" data-dismiss="modal">&times;</button>     
      <img src="https://premierconsumer.org/wp-content/uploads/2021/10/positive-logo.svg">
...
jQuery(document).ready(function() {
    jQuery('body').find('.text-phone :input').keypress(function(e){
        if(jQuery(this).val().length <= 12){
        if (e.keyCode < 48 || e.keyCode > 57 ) {
            e.preventDefault();    
        }
        jQuery(this).val(jQuery(this).val().replace(/^(\d{0})(\d{3})(\d{3})(\d)+$/, "$1($2)$3-$4"));
        }else{
        e.preventDefault();
        return false;
        }   
...
jQuery(document).ready(function() {
    ...
    //alert(page_id);
    if(page_id == 12406){
       jQuery(document).find(".stm-header__row_color_top .stm-header__cell_right ul").prepend('<li id="menu-item-wpml-ls-116-en" class="menu-item wpml-ls-slot-116 wpml-ls-item wpml-ls-item-en wpml-ls-menu-item wpml-ls-first-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-116-en"><a title="English" href="<?php echo get_site_url().'/courses/financial-course';?>"><span class="wpml-ls-native" lang="en">English</span></a></li><li id="menu-item-wpml-ls-116-es" class="menu-item wpml-ls-slot-116 wpml-ls-item wpml-ls-item-es wpml-ls-current-language wpml-ls-menu-item wpml-ls-last-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-116-es"><a title="Español" href="<?php echo get_site_url().'/cursos/cuestionarios-financieros/?lang=es';?>"><span class="wpml-ls-native" lang="es">Español</span></a></li>');
    }else if(page_id == 7299){
         jQuery(document).find(".stm-header__row_color_top .stm-header__cell_right ul").prepend('<li id="menu-item-wpml-ls-116-en" class="menu-item wpml-ls-slot-116 wpml-ls-item wpml-ls-item-en wpml-ls-current-language wpml-ls-menu-item wpml-ls-first-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-116-en"><a title="English" href="<?php echo get_site_url().'/courses/financial-course';?>"><span class="wpml-ls-native" lang="en">English</span></a></li><li id="menu-item-wpml-ls-116-es" class="menu-item wpml-ls-slot-116 wpml-ls-item wpml-ls-item-es wpml-ls-menu-item wpml-ls-last-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-116-es"><a title="Español" href="<?php echo get_site_url().'/cursos/cuestionarios-financieros/?lang=es';?>"><span class="wpml-ls-native" lang="es">Español</span></a></li>');
    }
});
</script>
